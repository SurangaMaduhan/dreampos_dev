                        ...
                        <tbody class="facetwp-template">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="me-3" data-toggle="modal" data-target="#view_product_<?php echo $product->get_id(); ?>">
                                            <img src="<?php echo get_bloginfo('template_directory'); ?>/src/img/eye.svg" alt="img">
                                        </button>

                                        <button type="button" class="me-3" data-toggle="modal" data-target="#edit_product_<?php echo $product->get_id(); ?>">
                                        ...
                                        <div id="edit_product_<?php echo $product->get_id(); ?>" class="modal fade bd-example-modal-lg newEdit" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-7">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="preview_wrap" style="display: none;">
                                                                        <img class="file-preview" alt="File Preview" src="<?php if ($image) {
                                                                                                                                echo $image;
                                                                                                                            } else {
                                                                                                                                echo get_template_directory_uri() . '/src/img/noimage.png';
                                                                                                                            }; ?>
                                                            ...
                                                            <div class="col-sm-5">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <label for="product_name">Product Brand</label>
                                                                        <textarea name="product_description" id="product_description" class="form-control"><?php echo $product->get_description(); ?></textarea>
                                                                    </div>
