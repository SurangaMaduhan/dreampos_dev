        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="dash-widget dash3">
                    <div class="dash-widgetimg">
                        <span><img src="<?php echo get_bloginfo('template_directory'); ?>/src/img/dash4.svg" alt="img"></span>
                    </div>
                    <div class="dash-widgetcontent">
                        ...
                        <div class="graph-sets">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-white btn-sm dropdown-toggle" type="button"
                                    ...
                                    2022 <img src="<?php echo get_bloginfo('template_directory'); ?>/src/img/dropdown.svg" alt="img" class="ms-2">
                                </button>
